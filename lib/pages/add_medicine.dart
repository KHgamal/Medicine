              ...
              children: [
                AddMedicineContainer(
                  child: Column(
                    ...
                    children: [
                      Center(child: Text("إضافة دواء",style:TextStyle(color:darkBlue,fontSize: 30 ,fontWeight:FontWeight.bold ),)),
                      ...
                      Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Image.asset("assets/no.jpg",width:100,height:200,fit: BoxFit.fitWidth,),
                          ),
                        ],
                      ),
                      Row(
